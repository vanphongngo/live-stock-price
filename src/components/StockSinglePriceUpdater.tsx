...
const StockPriceUpdater: React.FC = () => {
        ...
        const KEY_SINGLE_TICKER_LOCAL_STORAGE = "singleList";


        useEffect(() => {
            if (localStorage.getItem(KEY_SINGLE_TICKER_LOCAL_STORAGE) && inputRef.current) {
                inputRef.current.value = localStorage.getItem(KEY_SINGLE_TICKER_LOCAL_STORAGE) as string;
            }
        }, []);
        ...
        const handleSubscribe = () => {
            if (inputRef.current && inputRef.current.value) {
                ...
                localStorage.setItem(KEY_SINGLE_TICKER_LOCAL_STORAGE, inputRef.current.value);
                setBaseUrl(option);
            }
        };
        ...
        return (
            <div style={{width: '700px', wordWrap: 'break-word', alignSelf: 'left'}}>
                <h2>Stock Price Single Updater</h2>
                <div>
